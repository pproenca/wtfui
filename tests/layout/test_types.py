...
from wtfui.tui.layout.types import Border, Dimension, Edges, Rect, Size, Spacing
...
class TestFloatingPointPrecision:
    ...
    def test_layout_epsilon_constant(self):
        from wtfui.tui.layout.types import LAYOUT_EPSILON

        assert LAYOUT_EPSILON == 0.001

    def test_approx_equal_within_epsilon(self):
        from wtfui.tui.layout.types import approx_equal
    ...
    def test_snap_to_pixel_default(self):
        from wtfui.tui.layout.types import snap_to_pixel
