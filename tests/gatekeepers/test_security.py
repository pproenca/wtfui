...
These tests verify the core security requirements of the WtfUIByte compiler:
...
from wtfui.web.compiler.linker import Linker
...
from wtfui.ui import Button, Text
