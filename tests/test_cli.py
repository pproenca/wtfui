...
def test_cli_exists():
    ...
    assert "WtfUI" in result.output


def test_dev_command_exists():
    """wtfui dev command is available."""
    runner = CliRunner()
...
def test_build_command_exists():
    """wtfui build command is available."""
    runner = CliRunner()
...
def test_new_command_exists():
    """wtfui new command is available."""
    runner = CliRunner()
...
""")
    ...
    def test_dev_default_app_path(self):
        ...
        with patch("wtfui.cli.run_tui_mode") as mock_tui:
...
# =============================================================================
# TUI Mode Tests - Task 3: TUI mode as default for wtfui dev
# =============================================================================
...
class TestDevCommandTUIMode:
    ...
    def test_dev_web_flag_runs_server(self) -> None:
        ...
        with patch("wtfui.cli.run_web_mode") as mock_web:
...
class TestCliErrorMessages:
    ...
    def test_dev_no_app_suggests_init(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
        """When no app found, error suggests wtfui init command."""
