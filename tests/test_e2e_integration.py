...
from flow import Effect, Signal, component, provide, rpc
...
def test_full_build_pipeline():
    ...
    from flow.build import generate_client_bundle, generate_html_shell
...
def test_element_tree_building():
    ...
    with Div(cls="root") as root:
        with Div(cls="header") as header:  # noqa: SIM117
            with Text("Title"):
                pass
...
def test_renderer_protocol_consistency():
    ...
    from flow.renderer import DOMRenderer, HTMLRenderer
...
def test_element_registry_event_routing():
    ...
    with Button("Test", on_click=on_click) as btn:
        pass
...
def test_import_hook_transforms_client_modules():
    ...
    from flow.compiler import install_import_hook, uninstall_import_hook
